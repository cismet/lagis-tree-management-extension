 ...
 */
public class AddExistingBaumPanel extends javax.swing.JPanel implements ValidationStateChangedListener,ListSelectionListener {
    ...
    public void validationStateChanged(Object validatedObject) {
        ...
        if(flurstueckChooser1.getStatus() == flurstueckChooser1.VALID){
            ...
            Set<Baum> baeume= EJBroker.getInstance().getBaumForKey(currentKey);
            if(baeume != null){
                //Check if the Contract ist already  added
                //if(currentFlurstueck != null && currentFlurstueck.getVertraege() != null){
                Iterator<Baum> it = currentBaumTabelModel.getAllBaeume().iterator();
                while(it.hasNext()){
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
                    .addComponent(jLabel)
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        for(int i=0;i<selectedRows.length;i++){
            Baum curBaum = baumModel.getBaumAtRow(((JXTable)tblBaum).convertRowIndexToModel(selectedRows[i]));
            currentBaumTabelModel.addBaum(curBaum);
           currentBaumTabelModel.fireTableDataChanged();
            Set<FlurstueckSchluessel> crossRefs = EJBroker.getInstance().getCrossReferencesForBaum(curBaum);
            if(crossRefs != null){
